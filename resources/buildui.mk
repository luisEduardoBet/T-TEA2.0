...
# Useful commands:
# make -f buildui.mk -> build everything, copy and clean local files (normal usage)
# make -f buildui.mk copy -> copy only (useful for quick testing)
# make -f buildui.mk clean -> delete everything generated LOCALLY (preserves destination folder)
# make -f buildui.mk clean_copied -> delete only the *ui.py files in the destination folder
