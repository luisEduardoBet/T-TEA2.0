...
class Ui_InstitutionFacilityListView(object):
    ...
    def retranslateUi(self, InstitutionFacilityListView):
        InstitutionFacilityListView.setWindowTitle(QCoreApplication.translate("InstitutionFacilityListView", u"Plataforma T-TEA - Institui\u00e7\u00e3o / Estabelecimento de Sa\u00fade", None))
