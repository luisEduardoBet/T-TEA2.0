...
class Ui_MainView(object):
    def setupUi(self, MainView):
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/ui/menu/dooropenicon", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/ui/menu/userticon", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_player.setIcon(icon4)
        self.act_kartea = QAction(MainView)
        self.act_kartea.setObjectName(u"act_kartea")
        icon5 = QIcon()
        icon5.addFile(u":/icons/ui/menu/kartea4icon", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_kartea.setIcon(icon5)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons/ui/menu/questionicon", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_help.setIcon(icon8)
        self.act_about = QAction(MainView)
        self.act_about.setObjectName(u"act_about")
        icon9 = QIcon()
        icon9.addFile(u":/icons/ui/menu/infoicon", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_about.setIcon(icon9)
        self.act_player_game = QAction(MainView)
        self.act_player_game.setObjectName(u"act_player_game")
        icon10 = QIcon()
        icon10.addFile(u":/icons/ui/menu/gamepadicon", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_player_game.setIcon(icon10)
