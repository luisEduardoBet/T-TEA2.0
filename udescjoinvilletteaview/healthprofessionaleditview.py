...
from udescjoinvilletteacontroller import HealthProfessionalEditController
# class generated by pyside6-uic
from udescjoinvilletteaui import Ui_HealthProfessionalEditView
...
class HealthProfessionalEditView(
    QDialog, Ui_HealthProfessionalEditView, WindowConfig
):
    """Modal dialog for creating or editing a healthprofessional record.
    ...
    name_input : QLineEdit
        Input field for the healthprofessional's name.
    ...
    Methods
    -------
    __init__(parent=None, healthprofessional=None)
    ...
    def __init__(
        ...
        """Initialize the healthprofessional creation/editing dialog.
        ...
        healthprofessional : Optional[HealthProfessional], optional
            healthprofessional instance to edit.
        ...
        # ------------------------------------------------------------------
        action = (
            self.tr("Novo") if not healthprofessional else self.tr("Editar")
        )
        ...
        # ------------------------------------------------------------------
        self.controller = HealthProfessionalEditController(
