...
class Game:
    def __init__(self, surface):
        ...
        self.car = Car()
        # TODO: dar um aviso nesse ponto se não tiver config
        self.config = (
            "Jogadores/" + arquivo.get_Player() + "_KarTEA_config.csv"
        )
    ...
    def update(self):
        ...
        if self.PAUSE:
            ...
            if self.time_left > 0:
                ...
                troca_pista = (
                    settings.pista
                )  # Armazena a pista que o jogador se encotra
                if (div0_pista <= feet1_x < div1_pista) and (
                    div0_pista <= feet2_x < div1_pista
                ):  # Atualiza a pista do jogador, os 2 pés devem estar na pista
                    settings.pista = 0
                ...
                if (
                    div0_pista <= x < div1_pista
                ):  # Atualiza a pista do jogador de acordo com a posiçao central
                    settings.pista = 0
                ...
                if (
                    settings.pista != troca_pista
                ):  # Checa se houve troca de pista
                    print(
                        "Trocou da pista ",
                        troca_pista,
                        " para ",
