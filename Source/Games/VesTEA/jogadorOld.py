...
class Jogador:
    def __init__(self, jogo):
        ...
        print(
            "Pontos de Calibracao do RepeTEA: ", self.pontos_calibracao_repetea
        )
    ...
    def getPosicao(self):
        ...
        pts1 = np.float32(
            [
                self.pontos_calibracao_repetea[0],
                self.pontos_calibracao_repetea[1],
                self.pontos_calibracao_repetea[2],
                self.pontos_calibracao_repetea[3],
            ]
        )
        pts2 = np.float32(
            [
