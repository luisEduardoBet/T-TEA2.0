...
class Vestea:
    def __init__(self, jogador):
        ...
        display.set_caption("VesTEA")

        self.fundo = scale(load("VesTEA/images/space.jpg"), self.tamanho)
        ...
        while self.esta_rodando:
            ...
            for evento in event.get():  # Events
                if evento.type == QUIT:
                    ...
                    arq.grava_Sessao(
                        self.jogo.sessaoInicio,
                        self.jogo.fase,
                        self.jogo.nivel,
                        self.jogo.sessaoAcertos,
                        self.jogo.sessaoAcertosAjuda,
                        self.jogo.sessaoAjudas,
                        self.jogo.sessaoErros,
                        self.jogo.sessaoOmissoes,
                        self.jogo.totalColisoes,
                    )
                    ...
                    if evento.type == KEYUP:
                        ...
                        # ALTERA COR DE FUNDO
                            ...
                            arq.grava_Detalhado(
                                ...
                                0,
                                "Acao profissional",
                                f"Cor de Fundo {arq.get_V_FUNDO()}",
                            )
                            # print('HUD: ', bool(arq.get_V_HUD()))
                        #################################
                        #  PARA TESTES MANUAIS          #
            ...
            if self.estado == 0:
                ...
                self.imagem_tutorial = pygame.image.load(
                    "VesTEA/images/button_tutorial.png"
                ).convert_alpha()
                self.botao_tutorial = botao.Botao(
                    298, 250, self.imagem_tutorial, 1
                )
                self.imagem_opcoes = pygame.image.load(
                    "VesTEA/images/button_opcoes.png"
                ).convert_alpha()
                self.botao_opcoes = botao.Botao(
                    407, 340, self.imagem_opcoes, 1
                )
                self.imagem_personalizar = pygame.image.load(
                    "VesTEA/images/button_personalizar.png"
                ).convert_alpha()
                self.botao_personalizar = botao.Botao(
                    407, 430, self.imagem_personalizar, 1
                )
            ...
            #################################
                ...
                if self.tutorial.estado == 99:
                    arq.grava_Detalhado(
                        self.jogo.fase, self.jogo.nivel, 0, "Fim tutorial", ""
                    )
                    self.tutorial = Tutorial(self.superficie)
                    self.estado = 0
                # print(self.estado,' e ',self.jogo.estado)
            ...
            #################################
                ...
                # CRIA TÍTULO
                titulo = self.fonte_destaque.render(
                    "Configurações gerais", True, (50, 50, 50)
                )
                self.superficie.blit(titulo, (150, 60))
                # TEXTOS
                texto_opcoes = self.fonte.render(
                    "Imagem da parede", True, (50, 50, 50)
                )
                self.superficie.blit(texto_opcoes, (50, 165))
                texto_personalizar = self.fonte.render(
                    "Cor do fundo", True, (50, 50, 50)
                )
                self.superficie.blit(texto_personalizar, (50, 345))
                # botoes opções de tijolo
                self.imagem_tijolo1 = pygame.image.load(
                    "Assets/vestea/imgs/tijolo1.jpg"
                ).convert_alpha()
                self.botao_tijolo1 = botao.Botao(
                    320, 150, self.imagem_tijolo1, 1
                )
                self.imagem_tijolo2 = pygame.image.load(
                    "Assets/vestea/imgs/tijolo2.jpg"
                ).convert_alpha()
                self.botao_tijolo2 = botao.Botao(
                    470, 150, self.imagem_tijolo2, 1
                )
                self.imagem_tijolo3 = pygame.image.load(
                    "Assets/vestea/imgs/tijolo3.jpg"
                ).convert_alpha()
                self.botao_tijolo3 = botao.Botao(
                    620, 150, self.imagem_tijolo3, 1
                )
                ...
                pygame.draw.rect(
                    tijoloSelecionado, (0, 255, 0), (0, 0, 119, 121), 10
                )
                self.superficie.blit(
                    tijoloSelecionado,
                    tijoloSelecionado.get_rect(topleft=posicaotijolo),
                )
                # botoes cores de fundo
                self.imagem_cor1 = pygame.image.load(
                    "Assets/vestea/imgs/fundo1.jpg"
                ).convert_alpha()
                self.botao_cor1 = botao.Botao(320, 330, self.imagem_cor1, 1)
                self.imagem_cor2 = pygame.image.load(
                    "Assets/vestea/imgs/fundo2.jpg"
                ).convert_alpha()
                self.botao_cor2 = botao.Botao(470, 330, self.imagem_cor2, 1)
                self.imagem_cor3 = pygame.image.load(
                    "Assets/vestea/imgs/fundo3.jpg"
                ).convert_alpha()
                ...
                pygame.draw.rect(
                    fundoSelecionado, (0, 255, 0), (0, 0, 119, 121), 10
                )
                self.superficie.blit(
                    fundoSelecionado,
                    fundoSelecionado.get_rect(topleft=posicaofundo),
                )
                # botao sair
                self.imagem_sair = pygame.image.load(
                    "VesTEA/images/button_sair.png"
            ...
            #################################
                ...
                texto_personalizar = self.fonte.render(
                    "Hud (texto)", True, (50, 50, 50)
                )
                self.superficie.blit(texto_personalizar, (50, 420))
                # botoes opções de cor do ponto
                self.imagem_ponto1 = pygame.image.load(
                    "Assets/vestea/imgs/corponto1.jpg"
                ).convert_alpha()
                self.botao_ponto1 = botao.Botao(
                    320, 170, self.imagem_ponto1, 1
                )
                self.imagem_ponto2 = pygame.image.load(
                    "Assets/vestea/imgs/corponto2.jpg"
                ).convert_alpha()
                self.botao_ponto2 = botao.Botao(
                    400, 170, self.imagem_ponto2, 1
                )
                self.imagem_ponto3 = pygame.image.load(
                    "Assets/vestea/imgs/corponto3.jpg"
                ).convert_alpha()
                self.botao_ponto3 = botao.Botao(
                    480, 170, self.imagem_ponto3, 1
                )
                self.imagem_ponto4 = pygame.image.load(
                    "Assets/vestea/imgs/corponto4.jpg"
                ).convert_alpha()
                self.botao_ponto4 = botao.Botao(
                    560, 170, self.imagem_ponto4, 1
                )
                ...
                pygame.draw.rect(
                    pontoSelecionado, (0, 255, 0), (0, 0, 60, 60), 10
                )
                self.superficie.blit(
                    pontoSelecionado,
                    pontoSelecionado.get_rect(topleft=posicaoponto),
                )
                # botão som
                if arq.get_V_SOM():
                    self.imagem_som = pygame.image.load(
                        "Assets/vestea/imgs/on.png"
                    ).convert_alpha()
                else:
                    self.imagem_som = pygame.image.load(
                        "Assets/vestea/imgs/off.png"
                    ).convert_alpha()
                ...
                # botoes hud
                if arq.get_V_HUD():
                    self.imagem_hud = pygame.image.load(
                        "Assets/vestea/imgs/on.png"
                    ).convert_alpha()
                else:
                    self.imagem_hud = pygame.image.load(
            ...
            #################################
                ...
                # CRIA TÍTULO
                titulo = self.fonte_destaque.render(
                    "Configurações dos desafios", True, (50, 50, 50)
                )
                self.superficie.blit(titulo, (20, 10))
                ######  TEXTOS
                texto_opcoes = self.fonte.render("Corpo", True, (50, 50, 50))
                ...
                imagem_corpo1 = pygame.image.load(
                    "Assets/vestea/imgs/desafios/mini/Corpo1.png"
                ).convert_alpha()
                botao_corpo1 = botao.Botao(420, 80, imagem_corpo1, 1)
                legenda_corpo_1 = self.fonte_legenda.render(
                    "Superior", True, (50, 50, 50)
                )
                self.superficie.blit(legenda_corpo_1, (405, 175))
                imagem_corpo2 = pygame.image.load(
                    "Assets/vestea/imgs/desafios/mini/Corpo2.png"
                ).convert_alpha()
                botao_corpo2 = botao.Botao(515, 80, imagem_corpo2, 1)
                legenda_corpo_2 = self.fonte_legenda.render(
                    "Inferior", True, (50, 50, 50)
                )
                self.superficie.blit(legenda_corpo_2, (505, 175))
                imagem_corpo3 = pygame.image.load(
                    "Assets/vestea/imgs/desafios/mini/Corpo3.png"
                ).convert_alpha()
                ...
                imagem_corpo4 = pygame.image.load(
                    "Assets/vestea/imgs/desafios/mini/Corpo4.png"
                ).convert_alpha()
                botao_corpo4 = botao.Botao(700, 80, imagem_corpo4, 1)
                legenda_corpo_4 = self.fonte_legenda.render(
                    "Íntima", True, (50, 50, 50)
                )
                ...
                if botao_corpo1.criar(self.superficie):
                    # print('botao 1')
                    pygame.time.delay(300)
                    self.configdesafio.corpo["1"] = (
                        not self.configdesafio.corpo["1"]
                    )
                    if (
                        self.configdesafio.corpo["1"]
                        and self.configdesafio.corpo["2"]
                        and self.configdesafio.corpo["3"]
                        and self.configdesafio.corpo["4"]
                    ):
                        self.configdesafio.corpo["todos"] = True
                    else:
                        self.configdesafio.corpo["todos"] = False
                    if (
                        not self.configdesafio.corpo["1"]
                        and not self.configdesafio.corpo["2"]
                        and not self.configdesafio.corpo["3"]
                        and not self.configdesafio.corpo["4"]
                    ):
                        self.configdesafio.corpo["nenhum"] = True
                    else:
                        self.configdesafio.corpo["nenhum"] = False
                if botao_corpo2.criar(self.superficie):
                    # print('botao 2')
                    pygame.time.delay(300)
                    self.configdesafio.corpo["2"] = (
                        not self.configdesafio.corpo["2"]
                    )
                    if (
                        self.configdesafio.corpo["1"]
                        and self.configdesafio.corpo["2"]
                ...
                if botao_corpo3.criar(self.superficie):
                    # print('botao 3')
                    pygame.time.delay(300)
                    self.configdesafio.corpo["3"] = (
                        not self.configdesafio.corpo["3"]
                    )
                    if (
                        self.configdesafio.corpo["1"]
                        and self.configdesafio.corpo["2"]
                ...
                if botao_corpo4.criar(self.superficie):
                    # print('botao 4')
                    pygame.time.delay(300)
                    self.configdesafio.corpo["4"] = (
                        not self.configdesafio.corpo["4"]
                    )
                    if (
                        self.configdesafio.corpo["1"]
                        and self.configdesafio.corpo["2"]
                ...
                if self.configdesafio.corpo["1"]:
                    pygame.draw.rect(
                        imagem_corpo1, (0, 255, 0), (0, 0, 40, 90), 4
                    )
                    self.superficie.blit(
                        imagem_corpo1,
                        imagem_corpo1.get_rect(
                            topleft=botao_corpo1.rect.topleft
                        ),
                    )
                if self.configdesafio.corpo["2"]:
                    pygame.draw.rect(
                        imagem_corpo2, (0, 255, 0), (0, 0, 40, 90), 4
                    )
                    self.superficie.blit(
                        imagem_corpo2,
                        imagem_corpo2.get_rect(
                            topleft=botao_corpo2.rect.topleft
                        ),
                    )
                if self.configdesafio.corpo["3"]:
                    pygame.draw.rect(
                        imagem_corpo3, (0, 255, 0), (0, 0, 40, 90), 4
                    )
                    self.superficie.blit(
                        imagem_corpo3,
                        imagem_corpo3.get_rect(
                            topleft=botao_corpo3.rect.topleft
                        ),
                    )
                if self.configdesafio.corpo["4"]:
                    pygame.draw.rect(
                        imagem_corpo4, (0, 255, 0), (0, 0, 40, 90), 4
                    )
                    self.superficie.blit(
                        imagem_corpo4,
                        imagem_corpo4.get_rect(
                            topleft=botao_corpo4.rect.topleft
                        ),
                    )
                ######  CLIMA  ######
                # botoes opções de clima
                if self.configdesafio.clima["nenhum"]:
                    imagem_climanenhum = pygame.image.load(
                        "Assets/vestea/imgs/ativo.png"
                    ).convert_alpha()
                else:
                    imagem_climanenhum = pygame.image.load(
                ...
                botao_climanenhum = botao.Botao(
                    200, 205, imagem_climanenhum, 1
                )
                ...
                if self.configdesafio.clima["todos"]:
                    imagem_climatodos = pygame.image.load(
                        "Assets/vestea/imgs/ativo.png"
                    ).convert_alpha()
                else:
                    imagem_climatodos = pygame.image.load(
                ...
                imagem_clima1 = pygame.image.load(
                    "Assets/vestea/imgs/desafios/mini/Clima1.png"
                ).convert_alpha()
                ...
                imagem_clima2 = pygame.image.load(
                    "Assets/vestea/imgs/desafios/mini/Clima2.png"
                ).convert_alpha()
                ...
                if botao_clima1.criar(self.superficie):
                    # print('botao 1')
                    pygame.time.delay(300)
                    self.configdesafio.clima["1"] = (
                        not self.configdesafio.clima["1"]
                    )
                    if (
                        self.configdesafio.clima["1"]
                        and self.configdesafio.clima["2"]
                    ):
                        self.configdesafio.clima["todos"] = True
                    else:
                        self.configdesafio.clima["todos"] = False
                    if (
                        not self.configdesafio.clima["1"]
                        and not self.configdesafio.clima["2"]
                    ):
                        self.configdesafio.clima["nenhum"] = True
                    else:
                        self.configdesafio.clima["nenhum"] = False
                if botao_clima2.criar(self.superficie):
                    # print('botao 2')
                    pygame.time.delay(300)
                    self.configdesafio.clima["2"] = (
                        not self.configdesafio.clima["2"]
                    )
                    if (
                        self.configdesafio.clima["1"]
                        and self.configdesafio.clima["2"]
                ...
                if self.configdesafio.clima["1"]:
                    pygame.draw.rect(
                        imagem_clima1, (0, 255, 0), (0, 0, 80, 80), 6
                    )
                    self.superficie.blit(
                        imagem_clima1,
                        imagem_clima1.get_rect(
                            topleft=botao_clima1.rect.topleft
                        ),
                    )
                if self.configdesafio.clima["2"]:
                    pygame.draw.rect(
                        imagem_clima2, (0, 255, 0), (0, 0, 80, 80), 6
                    )
                    self.superficie.blit(
                        imagem_clima2,
                        imagem_clima2.get_rect(
                            topleft=botao_clima2.rect.topleft
                        ),
                    )
                ...
                if self.configdesafio.ocasiao["nenhum"]:
                    imagem_ocasiaonenhum = pygame.image.load(
                        "Assets/vestea/imgs/ativo.png"
                    ).convert_alpha()
                else:
                    imagem_ocasiaonenhum = pygame.image.load(
                ...
                botao_ocasiaonenhum = botao.Botao(
                    200, 310, imagem_ocasiaonenhum, 1
                )
                ...
                if self.configdesafio.ocasiao["todos"]:
                    imagem_ocasiaotodos = pygame.image.load(
                        "Assets/vestea/imgs/ativo.png"
                    ).convert_alpha()
                else:
                    imagem_ocasiaotodos = pygame.image.load(
                ...
                if botao_ocasiao1.criar(self.superficie):
                    # print('botao 1')
                    pygame.time.delay(300)
                    self.configdesafio.ocasiao["1"] = (
                        not self.configdesafio.ocasiao["1"]
                    )
                    if (
                        self.configdesafio.ocasiao["1"]
                        and self.configdesafio.ocasiao["2"]
                        and self.configdesafio.ocasiao["3"]
                        and self.configdesafio.ocasiao["4"]
                        and self.configdesafio.ocasiao["5"]
                        and self.configdesafio.ocasiao["6"]
                        and self.configdesafio.ocasiao["7"]
                        and self.configdesafio.ocasiao["8"]
                    ):
                        self.configdesafio.ocasiao["todos"] = True
                    else:
                        self.configdesafio.ocasiao["todos"] = False
                    if (
                        not self.configdesafio.ocasiao["1"]
                        and not self.configdesafio.ocasiao["2"]
                        and not self.configdesafio.ocasiao["3"]
                        and not self.configdesafio.ocasiao["4"]
                        and not self.configdesafio.ocasiao["5"]
                        and not self.configdesafio.ocasiao["6"]
                        and not self.configdesafio.ocasiao["7"]
                        and not self.configdesafio.ocasiao["8"]
                    ):
                        self.configdesafio.ocasiao["nenhum"] = True
                    else:
                        self.configdesafio.ocasiao["nenhum"] = False
                if botao_ocasiao2.criar(self.superficie):
                    # print('botao 2')
                    pygame.time.delay(300)
                    self.configdesafio.ocasiao["2"] = (
                        not self.configdesafio.ocasiao["2"]
                    )
                    if (
                        self.configdesafio.ocasiao["1"]
                        and self.configdesafio.ocasiao["2"]
                ...
                if botao_ocasiao3.criar(self.superficie):
                    # print('botao 3')
                    pygame.time.delay(300)
                    self.configdesafio.ocasiao["3"] = (
                        not self.configdesafio.ocasiao["3"]
                    )
                    if (
                        self.configdesafio.ocasiao["1"]
                        and self.configdesafio.ocasiao["2"]
                ...
                if botao_ocasiao4.criar(self.superficie):
                    # print('botao 4')
                    pygame.time.delay(300)
                    self.configdesafio.ocasiao["4"] = (
                        not self.configdesafio.ocasiao["4"]
                    )
                    if (
                        self.configdesafio.ocasiao["1"]
                        and self.configdesafio.ocasiao["2"]
                ...
                if botao_ocasiao5.criar(self.superficie):
                    # print('botao 5')
                    pygame.time.delay(300)
                    self.configdesafio.ocasiao["5"] = (
                        not self.configdesafio.ocasiao["5"]
                    )
                    if (
                        self.configdesafio.ocasiao["1"]
                        and self.configdesafio.ocasiao["2"]
                ...
                if botao_ocasiao6.criar(self.superficie):
                    # print('botao 6')
                    pygame.time.delay(300)
                    self.configdesafio.ocasiao["6"] = (
                        not self.configdesafio.ocasiao["6"]
                    )
                    if (
                        self.configdesafio.ocasiao["1"]
                        and self.configdesafio.ocasiao["2"]
                ...
                if botao_ocasiao7.criar(self.superficie):
                    # print('botao 7')
                    pygame.time.delay(300)
                    self.configdesafio.ocasiao["7"] = (
                        not self.configdesafio.ocasiao["7"]
                    )
                    if (
                        self.configdesafio.ocasiao["1"]
                        and self.configdesafio.ocasiao["2"]
                ...
                if botao_ocasiao8.criar(self.superficie):
                    # print('botao 8')
                    pygame.time.delay(300)
                    self.configdesafio.ocasiao["8"] = (
                        not self.configdesafio.ocasiao["8"]
                    )
                    if (
                        self.configdesafio.ocasiao["1"]
                        and self.configdesafio.ocasiao["2"]
                ...
                if self.configdesafio.ocasiao["1"]:
                    pygame.draw.rect(
                        imagem_ocasiao1, (0, 255, 0), (0, 0, 80, 55), 4
                    )
                    self.superficie.blit(
                        imagem_ocasiao1,
                        imagem_ocasiao1.get_rect(
                            topleft=botao_ocasiao1.rect.topleft
                        ),
                    )
                if self.configdesafio.ocasiao["2"]:
                    pygame.draw.rect(
                        imagem_ocasiao2, (0, 255, 0), (0, 0, 71, 80), 4
                    )
                    self.superficie.blit(
                        imagem_ocasiao2,
                        imagem_ocasiao2.get_rect(
                            topleft=botao_ocasiao2.rect.topleft
                        ),
                    )
                if self.configdesafio.ocasiao["3"]:
                    pygame.draw.rect(
                        imagem_ocasiao3, (0, 255, 0), (0, 0, 80, 80), 4
                    )
                    self.superficie.blit(
                        imagem_ocasiao3,
                        imagem_ocasiao3.get_rect(
                            topleft=botao_ocasiao3.rect.topleft
                        ),
                    )
                if self.configdesafio.ocasiao["4"]:
                    pygame.draw.rect(
                        imagem_ocasiao4, (0, 255, 0), (0, 0, 79, 80), 4
                    )
                    self.superficie.blit(
                        imagem_ocasiao4,
                        imagem_ocasiao4.get_rect(
                            topleft=botao_ocasiao4.rect.topleft
                        ),
                    )
                if self.configdesafio.ocasiao["5"]:
                    pygame.draw.rect(
                        imagem_ocasiao5, (0, 255, 0), (0, 0, 80, 64), 4
                    )
                    self.superficie.blit(
                        imagem_ocasiao5,
                        imagem_ocasiao5.get_rect(
                            topleft=botao_ocasiao5.rect.topleft
                        ),
                    )
                if self.configdesafio.ocasiao["6"]:
                    pygame.draw.rect(
                        imagem_ocasiao6, (0, 255, 0), (0, 0, 80, 72), 4
                    )
                    self.superficie.blit(
                        imagem_ocasiao6,
                        imagem_ocasiao6.get_rect(
                            topleft=botao_ocasiao6.rect.topleft
                        ),
                    )
                if self.configdesafio.ocasiao["7"]:
                    pygame.draw.rect(
                        imagem_ocasiao7, (0, 255, 0), (0, 0, 80, 80), 4
                    )
                    self.superficie.blit(
                        imagem_ocasiao7,
                        imagem_ocasiao7.get_rect(
                            topleft=botao_ocasiao7.rect.topleft
                        ),
                    )
                if self.configdesafio.ocasiao["8"]:
                    pygame.draw.rect(
                        imagem_ocasiao8, (0, 255, 0), (0, 0, 80, 80), 4
                    )
                    self.superficie.blit(
                        imagem_ocasiao8,
                        imagem_ocasiao8.get_rect(
                            topleft=botao_ocasiao8.rect.topleft
                        ),
                    )
                # botao voltar
                ...
                self.botao_voltar = botao.Botao(
                    30, 500, self.imagem_voltar, 0.15
                )
                ...
                if self.botao_jogar.criar(self.superficie):
                    self.jogo.configDesafio = self.configdesafio
                    if (
                        self.jogo.verificaDesafiosDisponiveis(self.jogo.fase)
                        == False
                    ):
