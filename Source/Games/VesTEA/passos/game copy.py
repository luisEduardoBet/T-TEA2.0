...
class Jogo:
    def __init__(self):
        ...
        display.set_caption("Dá Hadouken, Ryu!")
        ...
        self.fundo_inicio = scale(
            load("images/title_background.jpg"), self.tamanho
        )
...
class Jogador(Sprite):
    ...
    def update(self):
        ...
        if (
            keys[pygame.K_DOWN]
            and self.rect.y < self.jogo.tamanho[1] - self.rect.height
        ):
            self.rect.y += self.velocidade
