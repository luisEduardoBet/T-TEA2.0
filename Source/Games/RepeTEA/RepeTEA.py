...
)  # Configuração do MediaPipe. Ver https://google.github.io/mediapipe/solutions/pose.html para maiores detalhes.
mp_pose = (
    mp.solutions.pose
)  # Configuração do MediaPipe. Ver https://google.github.io/mediapipe/solutions/pose.html para maiores detalhes.
pontos_calibracao = np.zeros(
    (4, 2), int
)  # Matriz para os pontos de calibração de perspectiva - 4 linhas/ 2 colunas
...
lista_sorteio = (
    []
)  # São as figuras sorteadas pelo computador e colocadas nesta lista, para depois fazer a comparação com as escolhas do usuário
...
jogador_selecionado_config = (
    "Jogadores/" + arquivo.get_Player() + "_RepeTEA_config.csv"
)
jogador_selecionado_detalhado = (
    "Jogadores/" + arquivo.get_Player() + "_RepeTEA_detalhado.csv"
)
...
)  # O valor entre parênteses indica qual câmera será utilizada. 0=default; 1,2,3...= câmeras externas.
...
icone_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/icone.png"
)
atencao_perto_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/atencao_perto.png"
)
atencao_longe_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/atencao_longe.png"
)
trofeu_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/trofeu.png"
)
trofeu_25_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/trofeu_25.png"
)
trofeu_50_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/trofeu_50.png"
)
trofeu_75_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/trofeu_75.png"
)
triste_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/triste.png"
)
feliz_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/feliz.png"
)
vez_do_jogador_verde_1_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/vez_do_jogador_verde_1.png"
)
vez_do_jogador_verde_2_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/vez_do_jogador_verde_2.png"
)
base_com_pe_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/base_com_pe.png"
)
base_com_pe_verde_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/base_com_pe_verde.png"
)
base_com_pe_vermelho_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/base_com_pe_vermelho.png"
)
base_sem_pe_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/base_sem_pe.png"
)
avisos_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/avisos.png"
)
ajuda_f1_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/ajuda_F1.png"
)
instrucao_calibrar_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/calibrar.png"
)
repetea_iniciar_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/base_com_iniciar.png"
)
pausa_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/pause.png"
)
sem_sinal_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/sem_sinal.png"
)
tempo_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/tempo.png"
)
som_ligado_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/som_ligado.png"
)
som_desligado_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/som_desligado.png"
)
hud_on_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/hud_on.png"
)
hud_off_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/hud_off.png"
)
posicionamento_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/posicionamento.png"
)
fase_abaixo_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/fase_abaixo.png"
)
fase_acima_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/fase_acima.png"
)
silhueta_perto_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/silhueta_perto.png"
)
silhueta_longe_fig = pygame.image.load(
    "Assets/Repetea_Figuras/" + paleta_de_cores + "/silhueta_longe.png"
)
triagulo_longe_selecionado_fig = pygame.image.load(
    "Assets/Repetea_Figuras/"
    + paleta_de_cores
    + "/triangulo_selecionado_longe.png"
)
triagulo_longe_selecionado_ajuda_fig = pygame.image.load(
    "Assets/Repetea_Figuras/"
    + paleta_de_cores
    + "/triangulo_selecionado_longe_ajuda.png"
)
retangulo_longe_selecionado_fig = pygame.image.load(
    "Assets/Repetea_Figuras/"
    + paleta_de_cores
    + "/retangulo_selecionado_longe.png"
)
retangulo_longe_selecionado_ajuda_fig = pygame.image.load(
    "Assets/Repetea_Figuras/"
    + paleta_de_cores
    + "/retangulo_selecionado_longe_ajuda.png"
)
circulo_longe_selecionado_fig = pygame.image.load(
    "Assets/Repetea_Figuras/"
    + paleta_de_cores
    + "/circulo_selecionado_longe.png"
)
circulo_longe_selecionado_ajuda_fig = pygame.image.load(
    "Assets/Repetea_Figuras/"
    + paleta_de_cores
    + "/circulo_selecionado_longe_ajuda.png"
)
quadrado_longe_selecionado_fig = pygame.image.load(
    "Assets/Repetea_Figuras/"
    + paleta_de_cores
    + "/quadrado_selecionado_longe.png"
)
quadrado_longe_selecionado_ajuda_fig = pygame.image.load(
    "Assets/Repetea_Figuras/"
    + paleta_de_cores
    + "/quadrado_selecionado_longe_ajuda.png"
)
triagulo_perto_selecionado_fig = pygame.image.load(
    "Assets/Repetea_Figuras/"
    + paleta_de_cores
    + "/triangulo_selecionado_perto.png"
)
triagulo_perto_selecionado_ajuda_fig = pygame.image.load(
    "Assets/Repetea_Figuras/"
    + paleta_de_cores
    + "/triangulo_selecionado_perto_ajuda.png"
)
retangulo_perto_selecionado_fig = pygame.image.load(
    "Assets/Repetea_Figuras/"
    + paleta_de_cores
    + "/retangulo_selecionado_perto.png"
)
retangulo_perto_selecionado_ajuda_fig = pygame.image.load(
    "Assets/Repetea_Figuras/"
    + paleta_de_cores
    + "/retangulo_selecionado_perto_ajuda.png"
)
circulo_perto_selecionado_fig = pygame.image.load(
    "Assets/Repetea_Figuras/"
    + paleta_de_cores
    + "/circulo_selecionado_perto.png"
)
circulo_perto_selecionado_ajuda_fig = pygame.image.load(
    "Assets/Repetea_Figuras/"
    + paleta_de_cores
    + "/circulo_selecionado_perto_ajuda.png"
)
quadrado_perto_selecionado_fig = pygame.image.load(
    "Assets/Repetea_Figuras/"
    + paleta_de_cores
    + "/quadrado_selecionado_perto.png"
)
quadrado_perto_selecionado_ajuda_fig = pygame.image.load(
    "Assets/Repetea_Figuras/"
    + paleta_de_cores
    + "/quadrado_selecionado_perto_ajuda.png"
)

#################################################################################
################################# PALETA DE SONS ################################
#################################################################################
som_triangulo_wav = mixer.Sound(
    "Assets/Repetea_Sons/" + paleta_de_sons + "/1_triangulo.wav"
)
som_retangulo_wav = mixer.Sound(
    "Assets/Repetea_Sons/" + paleta_de_sons + "/2_retangulo.wav"
)
som_circulo_wav = mixer.Sound(
    "Assets/Repetea_Sons/" + paleta_de_sons + "/3_circulo.wav"
)
som_quadrado_wav = mixer.Sound(
    "Assets/Repetea_Sons/" + paleta_de_sons + "/4_quadrado.wav"
)
som_feliz_wav = mixer.Sound(
    "Assets/Repetea_Sons/" + paleta_de_sons + "/5_feliz.wav"
)
som_triste_wav = mixer.Sound(
    "Assets/Repetea_Sons/" + paleta_de_sons + "/6_triste.wav"
)
som_iniciar_wav = mixer.Sound(
    "Assets/Repetea_Sons/" + paleta_de_sons + "/7_iniciar.wav"
)
som_trofeu_wav = mixer.Sound(
    "Assets/Repetea_Sons/" + paleta_de_sons + "/8_trofeu.wav"
)
som_background_wav = mixer.Sound(
    "Assets/Repetea_Sons/" + paleta_de_sons + "/9_background.wav"
)
som_vez_do_jogador_1_wav = mixer.Sound(
    "Assets/Repetea_Sons/" + paleta_de_sons + "/10_vez_do_jogador_1.wav"
)
som_vez_do_jogador_2_wav = mixer.Sound(
    "Assets/Repetea_Sons/" + paleta_de_sons + "/10_vez_do_jogador_2.wav"
)
som_ajuda_wav = mixer.Sound(
    "Assets/Repetea_Sons/" + paleta_de_sons + "/11_ajuda.wav"
)
...
def hud_info():
    ...
    gameDisplay.blit(
        texto_jogador, [(0.05 * largura_projetor), (0.8 * altura_projetor)]
    )
    texto_nome_partida = font.render(nome_no_hud, True, branco)
    gameDisplay.blit(
        texto_nome_partida,
        [(0.15 * largura_projetor), (0.8 * altura_projetor)],
    )

    texto_tempo = font.render("Minutos:", True, branco)
    gameDisplay.blit(
        texto_tempo, [(0.05 * largura_projetor), (0.85 * altura_projetor)]
    )
    texto_tempo_partida = font.render(tempo_hud, True, branco)
    gameDisplay.blit(
        texto_tempo_partida,
        [(0.15 * largura_projetor), (0.85 * altura_projetor)],
    )

    texto_fase = font.render("Fase:", True, branco)
    gameDisplay.blit(
        texto_fase, [(0.7 * largura_projetor), (0.8 * altura_projetor)]
    )
    texto_fase_partida = font.render(fase_hud, True, branco)
    gameDisplay.blit(
        texto_fase_partida,
        [(0.76 * largura_projetor), (0.8 * altura_projetor)],
    )

    texto_tentativa = font.render("Tentativa:", True, branco)
    gameDisplay.blit(
        texto_tentativa, [(0.83 * largura_projetor), (0.8 * altura_projetor)]
    )
    texto_tentativa_partida = font.render(tentativa_hud, True, branco)
    gameDisplay.blit(
        texto_tentativa_partida,
        [(0.94 * largura_projetor), (0.8 * altura_projetor)],
    )

    texto_nivel = font.render("Nível:", True, branco)
    gameDisplay.blit(
        texto_nivel, [(0.7 * largura_projetor), (0.85 * altura_projetor)]
    )
    texto_nivel_partida = font.render(nivel_hud, True, branco)
    gameDisplay.blit(
        texto_nivel_partida,
        [(0.77 * largura_projetor), (0.85 * altura_projetor)],
    )
...
def posicao():
    ...
    pts1 = np.float32(
        [
            pontos_calibracao_repetea[0],
            pontos_calibracao_repetea[1],
            pontos_calibracao_repetea[2],
            pontos_calibracao_repetea[3],
        ]
    )
    pts2 = np.float32(
        [
    ...
    perspectiva = cv2.warpPerspective(
        tela_de_controle, matrix, (largura_tela_controle, altura_tela_controle)
    )

    # Posição do jogador:
    p = (
        int(x_pose * largura_tela_controle),
        int(y_pose * altura_tela_controle),
    )
...
while not gameExit:
    ...
    with mp_pose.Pose(
        ...
        while camera.isOpened():
            ...
            tela_de_controle = cv2.cvtColor(
                tela_de_controle, cv2.COLOR_RGB2BGR
            )
            ...
            try:
                ...
                # Depois da Calibração.
                    ...
                    if game_start == True:
                        ...
                        if (
                            nivel_sequencia == 1 and pausa_switch == False
                        ):  # NIVEL PERTO
                            ##########################
                            ####SORTEIO DA JOGADA#####
                            ##########################
                            ...
                            ###########################
                                ...
                                pygame.draw.circle(
                                    gameDisplay, (amarelo), jogador, 15
                                )
                                tela_update()
                                ...
                                if tempo <= tempo_ajuda:
                                    ...
                                    if (
                                        (jogador[0] > 0 and jogador[0] < 175)
                                        and (
                                            jogador[1] > 300
                                            and jogador[1] < 400
                                        )
                                        and figura_selecionada == False
                                    ):
                                        # print('triângulo')
                                        dadosDetalhado.append(
                                            [
                                                sessao,
                                                datetime.date.today(),
                                                datetime.datetime.now().time(),
                                                tamanho_sequencia_atual,
                                                nivel_sequencia_atual,
                                                posicao(),
                                                "Selecionou triângulo",
                                            ]
                                        )
                                        triangulo_perto_selecionado()
                                        som_triangulo()
                                        ...
                                        (jogador[0] > 175 and jogador[0] < 400)
                                        and (
                                            jogador[1] > 180
                                            and jogador[1] < 300
                                        )
                                        ...
                                        (jogador[0] > 400 and jogador[0] < 625)
                                        and (
                                            jogador[1] > 180
                                            and jogador[1] < 300
                                        )
                                        ...
                                        (jogador[0] > 625 and jogador[0] < 800)
                                        and (
                                            jogador[1] > 300
                                            and jogador[1] < 400
                                        )
                                        ...
                                        jogador[0] > 300 and jogador[0] < 500
                                    ) and (
                        ...
                        #################################################################################
                            ...
                            nivel_sequencia == 2 and pausa_switch == False
                        ):  # NIVEL LONGE:
                ...
                if contador > 3:
                    ...
                    cv2.putText(
                        ...
                        "SEM SINAL",
                        (
                            int(largura_projetor / 10),
                            (int(altura_projetor / 2)),
                        ),
                        fonte,
                        3,
                        verde,
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.QUIT:
                    ...
                    arquivo.set_R_FASE(
                        jogador_selecionado_config, tamanho_sequencia_atual
                    )
                    arquivo.set_R_NIVEL(
                        jogador_selecionado_config, nivel_sequencia_atual
                    )
                    ...
                    arquivo.gravaArrayDados(
                        jogador_selecionado_detalhado, dadosDetalhado
                    )
                    arquivo.gravaDados(
                        jogador_selecionado,
                        [
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_ESCAPE:
                        ...
                        arquivo.set_R_HUD(
                            jogador_selecionado_config, hud_switch
                        )
                        arquivo.set_R_SOM(
                            jogador_selecionado_config, som_switch
                        )
                        arquivo.set_R_SESSAO(
                            jogador_selecionado_config, sessao
                        )
                        dadosDetalhado.append(
                            [
                                sessao,
