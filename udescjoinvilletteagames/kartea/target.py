...
class Target:
    def __init__(self):
        ...
        self.images = [
            image.load(PathConfig.kartea_image("star.png"), size=size)
        ]
    ...
    def define_spawn_pos(
        self,
    ):  # define the start pos and moving vel of the mosquito
    ...
    def move(self):
        ...
        if ve == 1:
            if self.current_pos[1] % 10 == 0:
                ...
                self.images = [
                    image.load(
                        PathConfig.kartea_image("star.png"), size=self.tam
                    )
                ]
    ...
    def kill(
        self, surface, targets, sounds
    ):  # remove the mosquito from the list
